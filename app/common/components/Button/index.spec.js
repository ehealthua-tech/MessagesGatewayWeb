...
describe('Button', () => {
  ...
  describe('props', () => {
    ...
    it('theme', () => {
      expect(elem.render().find(`button.${styles['theme-border']}`)).toHaveLength(1);
    });

    it('size', () => {
      expect(elem.render().find(`button.${styles['size-small']}`)).toHaveLength(1);
    });

    it('color', () => {
      expect(elem.render().find(`button.${styles['color-blue']}`)).toHaveLength(1);
    });
    ...
    describe('to', () => {
      ...
      it('should work outer link', () => {
        ...
        expect(elem.render().find('a[href="http://google.com"]')).toHaveLength(1);
      });
    });
  });
});
